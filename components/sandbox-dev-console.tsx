...
const PROVES = [
  ...
  "GraphQL eligibility query reaches Optum sandbox and returns structured data",
  "Claude API key is valid and model responds to benefit interpretation prompts",
  "Full pipeline renders end-to-end: auth → eligibility → benefits → AI estimate",
]

const LIMITATIONS = [
  "Coverage dates are expired (PastPolicy) — eligibility may show inactive",
  "PII fields (name, address) are masked or synthetic",
  "Benefit and copay fields are sparse or empty",
  "Claude cost estimates will be low-confidence due to missing data",
]
...
export function SandboxDevConsole({
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <div className="rounded-sm border border-purple-400/20 bg-gray-950 overflow-hidden">
